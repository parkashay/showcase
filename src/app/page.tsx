      ...
      <section className="relative py-16 lg:py-24 px-6 overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <p className="animate-fade-in-up delay-200 font-body text-lg md:text-xl text-[#78716C] dark:text-[#A8A29E] max-w-xl mx-auto mb-10 leading-relaxed">
            A growing collection of side projects, mini apps, and code snippets I&apos;ve built —
            useful bits worth keeping around.
          </p>
              ...
              >
                ...
                <div className="absolute top-6 right-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="text-[#B45309] dark:text-[#F59E0B] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform"
                  >
                    <path d="M7 17 17 7" />
                    <path d="M7 7h10v10" />
                  </svg>
      ...
      <section className="py-16 px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="font-body text-sm text-[#A8A29E] dark:text-[#78716C] mt-6">
            Crafted by{" "}
            <span className="font-medium text-[#1C1917] dark:text-[#FAFAF7]">Prakash Poudel</span>
          </p>
        </div>
      </section>
    </div>
